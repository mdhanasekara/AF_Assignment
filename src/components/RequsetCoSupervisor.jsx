...
const RequestCoSupervisor = () => {
    ...
    const submitData = () => {
        ...
        axios.post("http://localhost:8000/requestCoSupervisor/save", newCoSupervisor).then(()=>{
    ...
    return(
        <Container>
        <StudentsNavBar/>
        <Typography variant='h4'>Request Co-Supervisor</Typography>
        <FormControl>
        ...
        <FormControl>
        <Button variant="contained" onClick={submitData}>Request Co-Supervisor</Button>
        </FormControl>
    </Container>
    )
